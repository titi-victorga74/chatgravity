    ...
    return (
        <div className="taquera-container">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h1 className="taquera-title" style={{ color: '#00d2ff' }}>Ruta: {cardName}</h1>
                <button
                    onClick={onBack}
                    style={{
            ...
            <div className="taquera-grid">
                ...
                <div className="taquera-panel">
                    <h2 style={{ color: 'var(--text-primary)', marginBottom: '1.5rem' }}>Registrar Ruta</h2>
                    ...
                    <button
                        ...
                        style={{
                            ...
                            padding: '1rem',
                            marginTop: '1rem',
                            background: '#00d2ff', // Blue for Ruta
                            color: '#000',
                ...
                <div className="taquera-saved-list">
                    <h2 style={{ color: 'var(--text-primary)', marginBottom: '1.5rem' }}>Ruta Registrada</h2>
                    {savedItems.length === 0 ? (
                        <p style={{ color: 'var(--text-secondary)', textAlign: 'center', padding: '2rem' }}>No hay datos de ruta registrados.</p>
                    ) : (
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            <thead>
                                <tr style={{ background: 'var(--bg-tertiary)', borderBottom: '2px solid var(--border-color)' }}>
                                    <th style={{ padding: '1rem', textAlign: 'left', color: '#00d2ff' }}>Item</th>
                                    <th style={{ padding: '1rem', textAlign: 'center', color: '#00d2ff', width: '80px' }}>Cant.</th>
                                    <th style={{ padding: '1rem', textAlign: 'left', color: '#00d2ff' }}>Fecha</th>
                                </tr>
                            </thead>
                            <tbody>
                                {savedItems.map(item => (
